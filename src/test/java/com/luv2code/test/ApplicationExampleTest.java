...
public class ApplicationExampleTest {
    ...
    public void beforeEach(){
        ...
        studentGrades.setMathGradeResults(new ArrayList<>(Arrays.asList(100.0,85.0,76.50,90.55)));
    ...
    public void addGradeResultsForStudentGrades(){
        assertEquals(352.05,studentGrades.addGradeResultsForSingleClass(student.getStudentGrades().getMathGradeResults()));
    }
